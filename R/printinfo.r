.printinfo <- function(mode, show, player, seqname, seqnum, score, played, i, totalmoves, random) {
   ...
   if (lang == "en") {
      ...
      if (mode == "play") {
         ...
         text(0.00, 0.15, paste0("Name:   ", "(", seqnum, ") ", seqname), pos=4, cex=cex, family=font, col=col)
