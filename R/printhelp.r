.printhelp <- function(lwd) {
   ...
   if (lang == "en") {
      ...
      "F9       - print the FEN of current position and copy it to the clipboard",
      "q        - quit the trainer",
      "",
   ...
   if (lang == "de") {
      ...
      "r        - Selektionsmodus w\U000000E4hlen",
      ...
      "F9       - die FEN der aktuellen Position drucken und in die Zwischenablage kopieren",
      "q        - Trainer beenden",
      "",
      ...
      "a und A  - aktuelle Sequenz/Position kopieren und mit weiteren Z\U000000FCgen erweitern",
