.printhelp <- function(...) {
   ...
   if (lang == "en") {
      ...
      cat("F3      - show current settings\n")
      cat("q       - quit the trainer\n")
      cat("\n")
      cat("Only in play mode:\n")
      cat("h       - get a hint (can select twice)\n")
      cat("t       - take back a score increase due to a wrong move\n")
   ...
   if (lang == "de") {
      ...
      cat("F3      - Einstellungen anzeigen\n")
      cat("q       - Trainer beenden\n")
      cat("\n")
      cat("Nur im Spiel Modus:\n")
      cat("h       - einen Tipp bekommen (kann zweimal gew\U000000E4hlt werden)\n")
      cat("t       - Punktekerh\U000000F6hung aufgrund eines falschen Zuges zur\U000000FCcknehmen\n")
      ...
      cat("b       - Zug zur\U000000FCcknehmen\n")
