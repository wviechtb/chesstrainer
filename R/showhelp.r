.showhelp <- function(page=1) {
   ...
   if (lang == "en") {
      ...
      "'        - select sequences that contain the same position",
      ";        - select sequences that end on the same position",
      ":        - select sequences with last-moved piece on current square",
      ...
      "i        - query the Lichess opening database (also in analysis/play mode)",
   ...
   if (lang == "de") {
      ...
      "'        - Sequenzen ausw\U000000E4hlen, die die gleiche Stellung beinhalten",
      ";        - Sequenzen ausw\U000000E4hlen, die mit der gleichen Stellung enden",
      ":        - Sequenzen ausw\U000000E4hlen, mit zuletzt bewegter Figur auf aktuellen Feld",
      ...
      "V        - Lichess Bewertungsbalken on/off",
      ...
      "i        - die Lichess Er\U000000F6ffnungsdatenbank abfragen (auch im Spiel- und Analysemodus)",
