.showhelp <- function(lwd) {
   ...
   if (lang == "en") {
      ...
      "? and '  - select all sequences with the same moves / position",
      "< and >  - bookmark a sequence / select and manage bookmarks",
      "m        - choose a sequence selection mode",
      "d        - choose a method for calculating the difficulty of the sequences",
      ...
      "F4-F7    - show settings / settings for colors, text, miscellanea, and Stockfish",
   ...
   if (lang == "de") {
      ...
      "? und '  - alle Sequenzen mit gleichen Z\U000000FCgen / gleicher Position ausw\U000000E4hlen",
      ...
      "d        - Methode zur Berechnung der Schwierigkeit der Sequenzen ausw\U000000E4hlen",
      ...
      "F3-F7    - Einstellungen anzeigen / f\U000000FCr Farben, Text, Sonstiges, und Stockfish",
