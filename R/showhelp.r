   ...
   if (lang == "en") {
      ...
      "?        - select sequences that start with the same moves",
      "' and ]  - select / show sequences that contain the same position",
      ";        - select sequences that end on the same position",
      ":        - select sequences with the last-moved piece on its current square",
      "[        - show the next moves of sequences that contain the same position",
      ...
      "Ctrl--/= - decrease/increase the margin width",
      ...
      "F3       - show settings",
      "F4       - settings for colors and text sizes",
      "F5       - settings for the trainer",
      "F6       - settings for miscellanea",
      "F7       - settings for Stockfish",
      "F8       - settings for Lichess",
      "F9       - add, remove, and select sequence directories",
      ...
      "W        - wait after completing a sequence",
      "%        - manually enter the score for the current sequence",
      "M        - manually trigger a mistake",
   ...
   if (lang == "de") {
      ...
      "?        - Sequenzen ausw\U000000E4hlen, die mit den gleichen Z\U000000FCgen anfangen",
      "' und ]  - Sequenzen ausw\U000000E4hlen / zeigen, die die gleiche Stellung beinhalten",
      ";        - Sequenzen ausw\U000000E4hlen, die mit der gleichen Stellung enden",
      ":        - Sequenzen ausw\U000000E4hlen, mit zuletzt bewegter Figur auf ihrem aktuellen Feld",
      "[        - Zeige die n\U000000E4chsten Z\U000000FCge von Sequenzen, die dieselbe Stellung beinhalten",
      ...
      "Strg--/= - Randbreite verringern/erh\U000000F6hen",
      ...
      "F4       - Einstellungen f\U000000FCr Farben und Textgr\U000000F6\U000000DFen",
      "F5       - Einstellungen f\U000000FCr den Trainer",
      "F6       - Einstellungen f\U000000FCr Sonstiges",
      "F7       - Einstellungen f\U000000FCr Stockfish",
      "F8       - Einstellungen f\U000000FCr Lichess",
      "F9       - Sequenzverzeichnisse hinzuf\U000000FCgen, entfernen und ausw\U000000E4hlen",
      ...
      "W        - Nach Abschluss einer Sequenz warten",
      "%        - Punktewert f\U000000FCr die aktuelle Sequenz manuell eingeben",
      "M        - Fehler manuell ausl\U000000F6sen",
