.text <- function(x, arg, arg2, arg3) {
   ...
   if (x == "colsetexpl") {
      return(switch(lang,
                    de = c("Hintergrundfarbe", "Vordergrundfarbe", "Farbe f\U000000FCr helle Felder", "Farbe f\U000000FCr dunkle Felder", "Farbe der zus\U000000E4tzlichen Felder im Brett-Editor", "Farbe f\U000000FCr Text oben", "Farbe f\U000000FCr Text unten", "Farbe des Hilfetext", "Farbe der Fensterrahmen", "Farbe f\U000000FCr Hinweise", "Farbe f\U000000FCr den Pfeil f\U000000FCr den besten Zug", "Farbe f\U000000FCr Pfeile f\U000000FCr andere gute Z\U000000FCge", "Farbe f\U000000FCr falsche Z\U000000FCge", "Farbe f\U000000FCr die Felder Rechtecke", "Farbe f\U000000FCr Annotationen", "Farbe f\U000000FCr den Seitenindikator (wei\U000000DF)", "Farbe f\U000000FCr den Seitenindikator (schwarz)", "Farbe f\U000000FCr Remis", "Farbe f\U000000FCr schnelle Zeiten im Zeitmodus", "Farbe f\U000000FCr langsame Zeiten im Zeitmodus"),
                         c("Background color", "Foreground color", "Color of light squares", "Color of dark squares", "Color of the extra squares in the board editor", "Color for text at the top", "Color for text at the bottom", "Color of help text", "Color of window borders", "Color for hints", "Color for the arrow for the best move", "Color for arrows for other good moves", "Color for wrong moves", "Color for the square rectangles", "Color for annotations", "Color for the side indicator (white)", "Color for the side indicator (black)", "Color for draws", "Color for fast times in timed mode", "Color for slow times in timed mode")
   ))}
   ...
   if (x == "showbestnumber") {
      return(switch(lang,
                    de = "Pfeile nummerieren f\U000000FCr die besten Z\U000000FCge",
                         "Number arrows for best moves"
   ))}
