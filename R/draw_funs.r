...
.redrawall <- function(pos, flip, show, showcomp, player, seqdir, seqdirpos, seqname, seqnum, opening, score, rounds, age, difficulty, i, totalmoves, sidetoplay, selmode, k, seqno, movestoplay, movesplayed, timetotal, timepermove) {
...
.drawglyph <- function(glyph) {
   ...
   col <- switch(glyph,
                 ...
                 "\U000025B3"           = "#c8c832",
                 "\U00002191"           = "#2660a4",
                 "\U00002191\U00002191" = "#c87e9d",
                 # glyphs2
                 "="                    = "#82c2ef",
                 "\U00002A72"           = "#999999",
                 "\U000000B1"           = "#aaaaaa",
                 "\U0000002B\U00002212" = "#bbbbbb",
                 "\U00002A71"           = "#555555",
                 "\U00002213"           = "#454545",
                 "\U00002212\U0000002B" = "#323232",
                 "\U0000221E"           = "#f5918f",
                 # anything else
                 "#999999"
                 )
...
.textbot <- function(show, showcomp, player, seqdir, seqdirpos, seqname, seqnum, opening="", score, rounds, age=NA, difficulty=NA, i, totalmoves, selmode="default", k, seqno, onlyshow=FALSE, onlyi=FALSE, onlyscore=FALSE, onlyeco=FALSE) {
