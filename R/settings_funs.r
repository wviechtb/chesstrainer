.colorsettings <- function(cols.all, pos, flip, mode, show, player, seqname, seqnum, score, played, age, difficulty, i, totalmoves, texttop, lwd, sidetoplay, selmode, timed, movestoplay, movesplayed, timetotal, timepermove, mar) {
   ...
   .redrawall(pos, flip, mode, zenmode=FALSE, show, player, seqname, seqnum, score, played, age, difficulty, i, totalmoves, texttop="Lorem ipsum", sidetoplay, selmode, timed=FALSE, movestoplay, movesplayed, timetotal, timepermove, mar)
...
.cexsettings <- function(pos, flip, mode, show, player, seqname, seqnum, score, played, age, difficulty, i, totalmoves, texttop, lwd, sidetoplay, selmode, timed, movestoplay, movesplayed, timetotal, timepermove, mar) {
   ...
   .redrawall(pos, flip, mode, zenmode=FALSE, show, player, seqname, seqnum, score, played, age, difficulty, i, totalmoves, texttop="Lorem ipsum", sidetoplay, selmode, timed, movestoplay, movesplayed, timetotal, timepermove, mar)
   .draweval(0.2, flip=flip)
